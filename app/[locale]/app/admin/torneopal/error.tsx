...
export default function AdminTorneopalError({
  error,
  reset,
  retry,
}: {
  ...
  useEffect(() => {
    console.error("AdminTorneopalError", error);
  }, [error]);

  return (
    <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-4 px-6 py-12">
      <h1 className="text-2xl font-semibold tracking-tight">無法載入 Torneopal 賽程頁</h1>
